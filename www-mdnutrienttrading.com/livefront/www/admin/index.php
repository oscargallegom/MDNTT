...
if ( ($generate != "") && ($generate >= 0) ) {
   ...
   if (count($nav_mgr->error) > 0) {
      ...
      echo "<table width=300><tr><td align=center><$nav_mgr->font color=green size=-1>The navigational include files have been regenerated successfully.</font></td></tr></table>";
   }
   $nav_mgr->show_error();
   echo "<P>";
